"""Runtime settings for collector_elexon_uk."""
...
SCHEMA_NAME = "collector_elexon_uk"
...
USER_AGENT = os.getenv("COLLECTOR_USER_AGENT", "collector_elexon_uk/0.1 (+https://github.com/lucasweber1202/collector_elexon_uk)")
